...
<body>
	...
	<div class="row">
		...
		<div class= "divBorder">
			...
			<div class="row">
				<div class="col-50">
					<h2>Sign up date: <fmt:formatDate pattern="MMM dd, yyyy" value="${currentUser.createdAt}" /></h2>
				</div>
				<div class="col-50">
					<h2></h2>
				</div>		
			...
			<div class="row">
				<div class="col-50">
					<h2>Last Sign in: <fmt:formatDate pattern="MMM dd, yyyy" value="${currentUser.lastSignIn}" /><!-- was "MMM dd, yyyy hhh mmm ssss" --></h2>
				</div>
				<div class="col-50">
					<h2>
